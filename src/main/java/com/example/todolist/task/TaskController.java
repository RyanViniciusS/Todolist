...
public class TaskController {
    ...
    public ResponseEntity<List<TaskModel>> list(HttpServletRequest request) {
        ...
        System.out.println("idUser recebido: " + idUser);
    ...
    @PutMapping("/{id}")
    public ResponseEntity uptdate(@RequestBody TaskModel taskmodel, @PathVariable UUID id, HttpServletRequest request) {
